...
class EpiTwitter extends EpiOAuth
{
  ...
  //post_statuses_update("status=".urlencode(stripslashes(urldecode($message))));
  ...
  public function updateStatus($message){
    $host = "http://twitter.com/statuses/update.json?status=".urlencode(stripslashes(urldecode($message))); 
    return new EpiTwitterJson($this->httpRequest('POST', $host));  
  }
