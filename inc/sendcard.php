...
*/
	...
	if($cf_show_advance_option_button=="1"){
		require_once("sendcard_advance_option.php");		
	}
	...
	if($_SESSION[ecardmax_user]==""){//Guest - Not login
		...
		if ($show_login) {
			$button_add_to_fav="<a class=\"button_link_style1\" id=\"button_add_to_fav\" href=\"$url_sign_in\">$sendcard_php_button_add_to_fav</a>";
			$button_next_step="<a class=\"button_link_style2\" id=\"button_show_personalize_table\" href=\"$url_sign_in\">$sendcard_php_button_join_now_to_send</a>";
			$display_personalize_table=0;
		}
		else {
			
			$button_add_to_fav="<a class=\"button_link_style1\" id=\"button_add_to_fav\" href=\"$url_sign_in\">$sendcard_php_button_add_to_fav</a>";
			$button_next_step="<a class=\"button_link_style2\" id=\"button_show_personalize_table\" href=\"javascript:void(0);\" onclick=\"ShowPersonalizeTable();\">$sendcard_php_button_continue_next_step</a>";
		...
		if ($show_balance_payment) {
			...
			if(($get_user_balance>=$get_ppc_amount) && $get_user_balance>0){
				...
				if ($can_send_ecard || $ec_id=="") {
					...
					if ($cf_ppc==1){
					$button_add_to_fav="<a class=\"button_link_style1\" id=\"button_add_to_fav\" href=\"javascript:void(0);\" onclick=\"Editme('$ecard_url/index.php?step=add_to_fav&ec_id=','$ec_id','1',1,'button_add_to_fav');\">$sendcard_php_button_add_to_fav</a>";
					$button_next_step="<a class=\"button_link_style2\" id=\"button_show_personalize_table\" href=\"javascript:void(0);\" onclick=\"ShowPersonalizeTable();\">$sendcard_php_button_continue_next_step</a>";
					$display_personalize_table=1;
					...
					$show_new_acct_balance=1;
						...
						$button_add_to_fav="<a class=\"button_link_style1\" id=\"button_add_to_fav\" href=\"".get_global_var(url_update_your_account)."\">$myaccount_button_upgrade_account</a>";
						$display_personalize_table=0;
				...
				$button_add_to_fav="<a class=\"button_link_style1\" id=\"button_add_to_fav\" href=\"javascript:void(0);\" onclick=\"Editme('$ecard_url/index.php?step=add_to_fav&ec_id=','$ec_id','1',1,'button_add_to_fav');\">$sendcard_php_button_add_to_fav</a>";
				$button_next_step="<a class=\"button_link_style2\" id=\"button_show_personalize_table\" href=\"".get_global_var(url_update_your_account)."\" >$sendcard_php_button_update_account_to_send</a>";
				$display_personalize_table=0;
				...
				if($ppc_row[ppc_buynow_title1]!="" && $ppc_row[ppc_payment_method1]!=""){
					...
					$button_buynow1="<a href=\"$ppc_payment_method1\" class=\"button_link_style1\">$ppc_buynow_title1 <strong>$get_ppc_amount</strong></a>";
				}
				else{
					$button_buynow1="";
				}
				...
				if($ppc_row[ppc_buynow_title2]!="" && $ppc_row[ppc_payment_method2]!=""){
					...
					$get_ppc_amount=price_format($get_ppc_amount);
					$button_buynow2="<a href=\"$ppc_payment_method2\" class=\"button_link_style2\">$ppc_buynow_title2 <strong>$get_ppc_amount</strong></a>";
				}
				else{
					$button_buynow2="";
				}							
				...
				$show_ppc_message=get_html_from_layout("templates/$cf_set_template/sendcard_show_change_next_step_fav_toolbar_ppc_message_not_enough_money.html");}
                        ...
                        if(!empty($fav_id)) $button_add_to_fav="<a class=\"button_link_style1\" id=\"button_remove_from_fav\" href=\"javascript:void(0);\" onclick=\"Editme('$ecard_url/index.php?step=remove_from_fav&ec_id=','$ec_id','1',1,'button_remove_from_fav');setTimeout(function(){location.reload();}, 2000);\">$sendcard_php_button_remove_from_fav</a>";
			else $button_add_to_fav="<a class=\"button_link_style1\" id=\"button_add_to_fav\" href=\"javascript:void(0);\" onclick=\"Editme('$ecard_url/index.php?step=add_to_fav&ec_id=','$ec_id','1',1,'button_add_to_fav');setTimeout(function(){location.reload();}, 2000);\">$sendcard_php_button_add_to_fav</a>";
			$button_next_step="<a class=\"button_link_style2\" id=\"button_show_personalize_table\" href=\"javascript:void(0);\" onclick=\"ShowPersonalizeTable();\">$sendcard_php_button_continue_next_step</a>";
			$display_personalize_table=1;
		}
	}
	...
	if($_SESSION[mg_allow_to_share_card_with_twitter]=="1" || $_SESSION[mg_allow_to_share_card_with_facebook]=="1" || $_SESSION[mg_allow_to_share_card_with_googleplus]=="1" || $_SESSION[mg_allow_to_share_card_with_linkedin]=="1"){
		$box_share.="<div class=\"box_share\" style=\"display:none;\">";
		$box_share.="<div style=\"display:inline; text-align:center;\">";
		$box_share.="<div style=\"display: inline-block;\">";
		$box_share.="<img title=\"Twitter\" src=\"$ecard_url/templates/$cf_set_template/images/share-medium.png\" style=\"padding-right: 5px; padding-top: 5px; margin: 0px; background-color: transparent; display: inline-block; \">";
		
		if($_SESSION[mg_allow_to_share_card_with_twitter]=="1") {
			$box_share.="<a id=\"atwitter\" href=\"javascript:;\" onclick=\"share_to_social('twitter');\"><img title=\"Twitter\" src=\"$ecard_url/templates/$cf_set_template/images/twitter.png\" style=\"padding-right: 5px; padding-top: 5px; margin: 0px; background-color: transparent; display: inline-block; border: 0px none; outline: medium none; width: 24px; height: 24px; box-shadow: none; max-width: none; opacity: 1;\" onmouseout=\"this.style.opacity=1;\" onmouseover=\"this.style.opacity=0.8;\"/></a>";
		}
		if($_SESSION[mg_allow_to_share_card_with_facebook]=="1") {
			$box_share.="<a id=\"afacebook\" href=\"javascript:;\" onclick=\"share_to_social('facebook');\"><img title=\"Facebook\" src=\"$ecard_url/templates/$cf_set_template/images/facebook.png\" style=\"padding-right: 5px; padding-top: 5px; margin: 0px; background-color: transparent; display: inline-block; border: 0px none; outline: medium none; width: 24px; height: 24px; box-shadow: none; max-width: none; opacity: 1;\" onmouseout=\"this.style.opacity=1;\" onmouseover=\"this.style.opacity=0.8;\"/></a>";
		}
		if($_SESSION[mg_allow_to_share_card_with_googleplus]=="1") {
			$box_share.="<a id=\"agoogleplus\" href=\"javascript:;\" onclick=\"share_to_social('googleplus');\"><img title=\"Google Plus\" src=\"$ecard_url/templates/$cf_set_template/images/googleplus.png\" style=\"padding-right: 5px; padding-top: 5px; margin: 0px; background-color: transparent; display: inline-block; border: 0px none; outline: medium none; width: 24px; height: 24px; box-shadow: none; max-width: none; opacity: 1;\" onmouseout=\"this.style.opacity=1;\" onmouseover=\"this.style.opacity=0.8;\"/></a>";
		}
		if($_SESSION[mg_allow_to_share_card_with_linkedin]=="1") {
			$box_share.="<a id=\"alinkedin\" href=\"javascript:;\" onclick=\"share_to_social('linkedin');\"><img title=\"Linkedin\" src=\"$ecard_url/templates/$cf_set_template/images/linkedin.png\" style=\"padding-right: 5px; padding-top: 5px; margin: 0px; background-color: transparent; display: inline-block; border: 0px none; outline: medium none; width: 24px; height: 24px; box-shadow: none; max-width: none; opacity: 1;\" onmouseout=\"this.style.opacity=1;\" onmouseover=\"this.style.opacity=0.8;\"/></a>";
		}
		$box_share.="</div>";
		$box_share.="</div>";
		$box_share.="</div>";*//
	...
	if($display_personalize_table=="1"){
		require_once("sendcard_show_personalize.php");		
	}
