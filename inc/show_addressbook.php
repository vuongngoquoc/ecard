...
*/
	...
	for ($z=$start; $z<$end; $z++) {
		...
		if(!(strpos($row_data[book_ag_relate_id],",0,")===false)){ //if true (match)
			$show_contact_group="<input onclick=\"if(this.checked){Editme('$ecard_url/index.php?step=$step&next_step=$next_step&action==update_book_ag_relate_id&doaction=add&book_id=$val&ag_id=','0',1,1,this.id);}else{Editme('$ecard_url/index.php?step=$step&next_step=$next_step&action=update_book_ag_relate_id&doaction=remove&book_id=$val&ag_id=','0',1,1,this.id);}\" class=\"input_ajax_editable\" type=\"checkbox\" name=\"change_bkg\" id=\"book_ag_relate_id0$val\" checked=\"checked\" /> <strong>$addressbook_group_default_name</strong> <img onclick=\"location.href='$ecard_url/index.php?step=$step&next_step=$next_step&action=list_group_contact&ag_id=0';\" border=\"0\" alt=\"$addressbook_icon_tooltip_list_all_contact_this_group\" title=\"$addressbook_icon_tooltip_list_all_contact_this_group\" src=\"$ecard_url/templates/$cf_set_template/icon_arrow_view_contact.gif\" style=\"vertical-align:middle;cursor:pointer;\" /><br />";
		}
		else{
			$show_contact_group="<input onclick=\"if(this.checked){Editme('$ecard_url/index.php?step=$step&next_step=$next_step&action=update_book_ag_relate_id&doaction=add&book_id=$val&ag_id=','0',1,1,this.id);}else{Editme('$ecard_url/index.php?step=$step&next_step=$next_step&action=update_book_ag_relate_id&doaction=remove&book_id=$val&ag_id=','0',1,1,this.id);}\" class=\"input_ajax_editable\" type=\"checkbox\" name=\"change_bkg\" id=\"book_ag_relate_id0$val\" /> <strong>$addressbook_group_default_name</strong> <img onclick=\"location.href='$ecard_url/index.php?step=$step&next_step=$next_step&action=list_group_contact&ag_id=0';\" border=\"0\" alt=\"$addressbook_icon_tooltip_list_all_contact_this_group\" title=\"$addressbook_icon_tooltip_list_all_contact_this_group\" src=\"$ecard_url/templates/$cf_set_template/icon_arrow_view_contact.gif\" style=\"vertical-align:middle;cursor:pointer;\" /><br />";
		}
		...
		foreach($list_bgroup as $row_data_ag){
			if(!(strpos($row_data[book_ag_relate_id],",$row_data_ag[ag_id],")===false)){ //if true (match)
				$show_contact_group.="<input onclick=\"if(this.checked){Editme('$ecard_url/index.php?step=$step&next_step=$next_step&action=update_book_ag_relate_id&doaction=add&book_id=$val&ag_id=','$row_data_ag[ag_id]',1,1,this.id);}else{Editme('$ecard_url/index.php?step=$step&next_step=$next_step&action=update_book_ag_relate_id&doaction=remove&book_id=$val&ag_id=','$row_data_ag[ag_id]',1,1,this.id);}\" class=\"input_ajax_editable\" type=\"checkbox\" name=\"change_bkg\" id=\"book_ag_relate_id$row_data_ag[ag_id]$val\" checked=\"checked\" /> $row_data_ag[ag_title] <img onclick=\"location.href='$ecard_url/index.php?step=$step&next_step=$next_step&action=list_group_contact&ag_id=$row_data_ag[ag_id]';\" border=\"0\" alt=\"$addressbook_icon_tooltip_list_all_contact_this_group\" title=\"$addressbook_icon_tooltip_list_all_contact_this_group\" src=\"$ecard_url/templates/$cf_set_template/icon_arrow_view_contact.gif\" style=\"vertical-align:middle;cursor:pointer;\" /><br />";
			}
			else{
				$show_contact_group.="<input onclick=\"if(this.checked){Editme('$ecard_url/index.php?step=$step&next_step=$next_step&action=update_book_ag_relate_id&doaction=add&book_id=$val&ag_id=','$row_data_ag[ag_id]',1,1,this.id);}else{Editme('$ecard_url/index.php?step=$step&next_step=$next_step&action=update_book_ag_relate_id&doaction=remove&book_id=$val&ag_id=','$row_data_ag[ag_id]',1,1,this.id);}\" class=\"input_ajax_editable\" type=\"checkbox\" name=\"change_bkg\" id=\"book_ag_relate_id$row_data_ag[ag_id]$val\" /> $row_data_ag[ag_title] <img onclick=\"location.href='$ecard_url/index.php?step=$step&next_step=$next_step&action=list_group_contact&ag_id=$row_data_ag[ag_id]';\" border=\"0\" alt=\"$addressbook_icon_tooltip_list_all_contact_this_group\" title=\"$addressbook_icon_tooltip_list_all_contact_this_group\" src=\"$ecard_url/templates/$cf_set_template/icon_arrow_view_contact.gif\" style=\"vertical-align:middle;cursor:pointer;\" /><br />";
			}
		...
		$show_important_date="<div class=\"show_calendar_birthday\" id=\"show_calendar_birthday$val\" style=\"cursor:pointer;\" onclick=\"calendar_what='birthday';get_cid=$val;ShowDiv(this.id,'view_fullsize_table_birthday',0,0);info=document.getElementById('time_end_textbox$val').value.split('\/');cf_show_date_option='$cf_show_date_option';if(cf_show_date_option=='0'){selected_month=info[0];selected_day=info[1];selected_year=info[2];}else if(cf_show_date_option=='1'){selected_day=info[0];selected_month=info[1];selected_year=info[2];}else if(cf_show_date_option=='2'){selected_year=info[0];selected_day=info[1];selected_month=info[2];}else if(cf_show_date_option=='3'){selected_year=info[0];selected_month=info[1];selected_day=info[2];};frames['calendar_frame'].location.href='$ecard_url/index.php?step=calendar&year_from=1900&year_to=$today_year&mode=1&month='+selected_month+'&year='+selected_year+'&selected_day='+selected_day+'&selected_month='+selected_month+'&selected_year='+selected_year\"><img border=\"0\"  alt=\"$addressbook_txt_reminder_birthday_tooltip\" title=\"$addressbook_txt_reminder_birthday_tooltip\" style=\"vertical-align:middle\" src=\"$ecard_url/templates/$cf_set_template/icon_calendar_birthday.gif\" /> <input class=\"input_ajax_editable\" readonly=\"readonly\" type=\"text\" name=\"change_bkg\" id=\"time_end_textbox$val\" value=\"$show_user_birthday\" style=\"width:100px\" title=\"$ins_date_caption\"/></div> ";
		...
		$show_important_date.="<div class=\"show_calendar_birthday\" id=\"show_calendar_anni$val\" style=\"cursor:pointer;\" onclick=\"calendar_what='anni';get_cid=$val;ShowDiv(this.id,'view_fullsize_table_birthday',0,0);info=document.getElementById('time_end_textbox_anni$val').value.split('\/');cf_show_date_option='$cf_show_date_option';if(cf_show_date_option=='0'){selected_month=info[0];selected_day=info[1];selected_year=info[2];}else if(cf_show_date_option=='1'){selected_day=info[0];selected_month=info[1];selected_year=info[2];}else if(cf_show_date_option=='2'){selected_year=info[0];selected_day=info[1];selected_month=info[2];}else if(cf_show_date_option=='3'){selected_year=info[0];selected_month=info[1];selected_day=info[2];};frames['calendar_frame'].location.href='$ecard_url/index.php?step=calendar&year_from=1900&year_to=$today_year&mode=1&month='+selected_month+'&year='+selected_year+'&selected_day='+selected_day+'&selected_month='+selected_month+'&selected_year='+selected_year\"><img border=\"0\" alt=\"$addressbook_txt_reminder_anni_tooltip\" title=\"$addressbook_txt_reminder_anni_tooltip\" style=\"vertical-align:middle\" src=\"$ecard_url/templates/$cf_set_template/icon_calendar_anni.gif\" /> <input class=\"input_ajax_editable\" readonly=\"readonly\" type=\"text\" name=\"change_bkg\" id=\"time_end_textbox_anni$val\" value=\"$show_user_anni\" style=\"width:100px\" title=\"$ins_date_caption\"/></div>";
		...
		$show_view_edit_icon="<img border=\"0\" onclick=\"ShowDivCenterPage('popup_detail$val',1);\" style=\"cursor:pointer\" alt=\"$addressbook_table_icon_tooltip_view_edit_contact\" title=\"$addressbook_table_icon_tooltip_view_edit_contact\" src=\"$ecard_url/templates/$cf_set_template/icon_edit_view_contact.gif\" />";

		//Show delete button
		$show_delete_button="<img onclick=\"document.getElementById('bk$val').checked='true';single_check_uncheck('tr$val','bk$val');CheckSelected();\" border=\"0\" src=\"$ecard_url/templates/$cf_set_template/icon_delete.gif\" style=\"cursor:pointer\" alt=\"$addressbook_table_icon_tooltip_delete\" title=\"$addressbook_table_icon_tooltip_delete\" />";

		$show_list_table .="<tr id=\"tr$val\" class=\"table_td_background\">\n";
		$show_list_table .="<td width=\"1%\" align=\"center\" valign=\"top\" style=\"padding:7px;\" id=\"cell$val\">$show_view_edit_icon</td>\n";
		$show_list_table .="<td width=\"*\" style=\"padding:7px;cursor:pointer\" valign=\"top\" onclick=\"ShowDivCenterPage('popup_detail$val',1);\" title=\"$addressbook_table_icon_tooltip_view_edit_contact\">$show_contact_title</td>\n";
		$show_list_table .="<td width=\"*\" style=\"padding:7px;white-space:nowrap\" align=\"left\" valign=\"top\">$show_contact_group</td>\n";
		$show_list_table .="<td width=\"1%\" align=\"center\" valign=\"top\" style=\"padding:7px;white-space:nowrap\">$show_important_date</td>\n";		
		$show_list_table .="<td width=\"1%\" align=\"center\" valign=\"top\" style=\"padding:7px;\">$show_delete_button</td>\n";
		$show_list_table .="<td width=\"1%\" align=\"center\" valign=\"top\" style=\"padding:7px;\"><input class=\"input_ajax_editable\" onclick=\"single_check_uncheck('tr$val','bk$val');\" type=\"checkbox\" id=\"bk$val\" name=\"mylist_id$val\" value=\"$val\" /></td>\n";
		$show_list_table .="</tr>\n";
		$bk_id .="$val,";
		$xrow++;
	}
