...
*/
	...
	foreach($list_data as $row_data){
		...
		$show_list_skin_icon .="<div class=\"select_overflow_cell\" onclick=\"cs_skin_name='$row_data[skin_dirname]';GetSkinCode('$ecard_url/resource/skin/$row_data[skin_dirname]/$bar,$barW,$barH','$ecard_url/resource/skin/$row_data[skin_dirname]/$bkg','$ecard_url/resource/skin/$row_data[skin_dirname]/$bottom,$bottomW,$bottomH','$ecard_url/resource/skin/$row_data[skin_dirname]/$icon,$iconW,$iconH','$ecard_url/resource/skin/$row_data[skin_dirname]/$top,$topW,$topH','$ecard_url/resource/skin/$row_data[skin_dirname]/$poem,$poemW,$poemH','$row_data[skin_text_color]');\"><img border=\"0\" src=\"$src\" alt=\"\" style=\"vertical-align:middle\"/> $row_data[skin_name_display]</div>";		
	}
...
<script type="text/javascript">
	...
	function GetSkinCode(skinBar,skinBkg,skinBottom,skinIcon,skinTop,skinPoem,skinTextColor){
		self.parent.GetSkinCode(cs_skin_name,skinBar,skinBkg,skinBottom,skinIcon,skinTop,skinPoem,skinTextColor);
	}
</script>
EOF;
