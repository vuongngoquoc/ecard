...
*/
	...
	$button_more_cards_up="<a class=\"button_link_style1\" id=\"button_more_cards_up\" href=\"javascript:void(0);\" onclick=\"HideItAll();ShowDiv(this.id,'div_show_more_ecard',0,0,0)\">$show_card_body_more_card</a>";
	$button_more_cards="<a class=\"button_link_style1\" id=\"button_more_cards\" href=\"javascript:void(0);\" onclick=\"HideItAll();ShowDiv(this.id,'div_show_more_ecard',0,0,0)\">$show_card_body_more_card</a>";
	...
	if($_SESSION[ecardmax_user]==""){//Guest - Not login
		if(!(strpos($ec_row[ec_group_relate_id],",1,")===false)){//Match -> guest can send this card
			$button_add_to_fav="<a class=\"button_link_style1\" id=\"button_add_to_fav\" href=\"$ecard_url/index.php?step=sign_in\">$sendcard_php_button_add_to_fav</a>";
			...
			$button_add_to_fav="<a class=\"button_link_style1\" id=\"button_add_to_fav\" href=\"$ecard_url/index.php?step=sign_in\">$sendcard_php_button_add_to_fav</a>";
			$button_next_step="<a class=\"button_link_style2\" id=\"button_show_personalize_table\" href=\"$ecard_url/index.php?step=sign_in\">$sendcard_php_button_join_now_to_send</a>";
		...
		if(!(strpos($ec_row[ec_group_relate_id],",$_SESSION[user_mg_id],")===false) || !(strpos($ec_row[ec_group_relate_id],",1,")===false)){//Match -> member can send this card
			...
			if($get_user_balance>=$get_ppc_amount && $get_ppc_amount>0){
				...
				$button_add_to_fav="<a class=\"button_link_style1\" id=\"button_add_to_fav\" href=\"javascript:void(0);\" onclick=\"Editme('$ecard_url/index.php?step=add_to_fav&ec_id=','$ec_id','1',1,'button_add_to_fav');\">$sendcard_php_button_add_to_fav</a>";
				$button_next_step="<a class=\"button_link_style2\" id=\"button_show_personalize_table\" href=\"$ecard_url/index.php?step=update_your_account\" >$sendcard_php_button_update_account_to_send</a>";
				$display_personalize_table=0;
				...
				if($ppc_row[ppc_buynow_title1]!="" && $ppc_row[ppc_payment_method1]!=""){
					$button_buynow1="<a href=\"$ppc_row[ppc_payment_method1]\" class=\"button_link_style1\">$ppc_row[ppc_buynow_title1] <strong>\$$get_ppc_amount</strong></a>";
				}
				else{
					$button_buynow1="";
				}
				...
				if($ppc_row[ppc_buynow_title2]!="" && $ppc_row[ppc_payment_method2]!=""){
					$button_buynow2="<a href=\"$ppc_row[ppc_payment_method2]\" class=\"button_link_style2\">$ppc_row[ppc_buynow_title2] <strong>\$$get_ppc_amount</strong></a>";
				}
				else{
					$button_buynow2="";
				}							
