...
*/
	...
	foreach($list_data as $row_data){
		$show_table_group .="<h2 id='title-1' class=\"table_title_bar\">$update_your_account_join_group_name $row_data[mg_title] (".price_format($row_data[mg_payment_amount]).")</h2>";
		$show_table_group .="<table class='table table-condensed' ><tr><td>";	
		...
		$show_table_group .="<div style=\"float:left;width:85%;border-bottom:1px dashed silver\">  $myaccount_payment_amount</div><span class=\"OK_Message\">".price_format($row_data[mg_payment_amount])."</span><br /><br />";
		...
		if($row_data[mg_buynow_title1]!="" && $row_data[mg_payment_method1]!=""){
			$button_buynow1="<a href=\"$row_data[mg_payment_method1]\" class=\"btn btn-sm btn-default btn-my-site\">$row_data[mg_buynow_title1] <strong>".price_format($row_data[mg_payment_amount])."</strong></a>";
		}
		else{
			$button_buynow1="";
		}
		...
		if($row_data[mg_buynow_title2]!="" && $row_data[mg_payment_method2]!=""){
			$button_buynow2="<a href=\"$row_data[mg_payment_method2]\" class=\"btn btn-default btn-sm btn-my-site\">$row_data[mg_buynow_title2] <strong>".price_format($row_data[mg_payment_amount])."</strong></a>";
		}
		else{
			$button_buynow2="";
		}
	...
	$show_table_group .= '<style>tbody>tr>td{ border-top: none !important }</style>';
